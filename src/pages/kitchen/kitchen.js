...
export const Kitchen = () => {
  ...
  return (
    <section className="menu">
      ...
      <FilteredOrderProduct orderStatus={'Preparar'} dayShift={'PEDIDOS PENDENTES'} orderList={orders} filterFunction={pendingOrders}></FilteredOrderProduct>
      <FilteredOrderProduct orderStatus={'Finalizar'} dayShift={'PEDIDOS EM PRODUÇÃO'} orderList={orders} filterFunction={preparingOrders}></FilteredOrderProduct>
